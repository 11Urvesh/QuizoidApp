  ...
  Widget build(BuildContext context) {
    ...
    void createQuiz(BuildContext _context) async {
      SnackBar mySnackbar1 = SnackBar(
          ...
          content: Text('Creating Quiz...Please Wait!',
              style:
      ...
      child: Scaffold(
                            ...
                            child: Card(
                              child: TextField(
                                ...
                                onChanged: (value) {
                                  if (value == null || value == '') {
                                    quizTitle =
                                        'Quiz - ${DateFormat.yMd("en_US").format(DateTime.now())}';
                                  }
        ...
        floatingActionButton: isDone
            ...
            : FloatingActionButton(
                ...
                onPressed: () => questionInput(context)),
      ),
    );
  }
}
