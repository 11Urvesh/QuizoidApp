        ...
        return Card(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return ExpansionTile(
              ...
              children: [
                ListTile(
                  tileColor: answers[index] == 1 ? Colors.green.withOpacity(0.3):Colors.white,
                  title: Text(options[index]['1']),
                  leading: Text('a)'),
                ),
                ListTile(
                  tileColor: answers[index] == 2 ? Colors.green.withOpacity(0.3):Colors.white,
                  title: Text(options[index]['2']),
                  leading: Text('b)'),
                ),
                ListTile(
                  tileColor: answers[index] == 3 ? Colors.green.withOpacity(0.3):Colors.white,
                  title: Text(options[index]['3']),
                  leading: Text('c)'),
                ),
                ListTile(
                  tileColor: answers[index] == 4 ? Colors.green.withOpacity(0.3):Colors.white,
